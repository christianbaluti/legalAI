            ...
            <div class="row justify-content-center">
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="services.html#matching">Client-Lawyer matching</a></li>
                        <li><a href="services.html#management">Case followup and management</a></li>
                        <li><a href="services.html#ai">AI document drafting</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last">
                    <div class="fw-bold d-flex align-items-center mb-2"><span class="bs-icon-sm bs-icon-circle bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-app-indicator">
                            ...
                            </svg></span><span>law consultency</span></div>
                    <p class="text-muted">This is a platform where citizens will get connected to lawyers in whatever legal case you have</p>
                </div>
            </div>
            <hr>
            <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                <p class="mb-0">Copyright © 2023 law consultency</p>
            </div>
        </div>
    </footer>